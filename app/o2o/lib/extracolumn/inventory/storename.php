 ...
 * @version 1.0
 */
class o2o_extracolumn_inventory_storename extends o2o_extracolumn_abstract implements o2o_extracolumn_interface{
    ...
    public function associatedData($ids){
        ...
        $rs_info = $mdlO2oInventory->getList("inventory_id,branch_id",array("inventory_id|in"=>$ids));
        $branch_ids = array();
        ...
        foreach ($rs_info as $item_info){
            $return_arr[$item_info["inventory_id"]] = $rl_branch_id_name[$item_info["branch_id"]];
        }
