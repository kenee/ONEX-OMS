 ...
 */
/**
 * Class erpapi_shop_matrix_weimobv_response_exchange
 */
class erpapi_shop_matrix_weimobv_response_exchange extends erpapi_shop_response_exchange
{
    ...
    protected function _returnProductAdditional($sdf)
    {
        $ret = array(
            ...
            'data'  => array(
                'reship_bn' => $sdf['alipay_no'],//平台换出订单号
