...
class erpapi_shop_matrix_shopex_ecshopx_request_v2_finance extends erpapi_shop_matrix_shopex_ecshopx_request_finance {
    ...
    protected function _setParams($refund){
        ...
        if($refund_apply_info[0]['return_id']){
            $return_info = app::get('ome')->model('return_product')->getList('memo,return_bn',array('return_id'=>$refund_apply_info[0]['return_id']), 0, 1);
        }
        $params['return_bn'] = $return_info[0]['return_bn'];
