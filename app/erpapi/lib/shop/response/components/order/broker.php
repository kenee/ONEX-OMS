...
*/
class erpapi_shop_response_components_order_broker extends erpapi_shop_response_components_order_abstract
{
    // 组件集合
    ...
    {
        $component = kernel::single('erpapi_shop_response_components_order_'.$component_name);
    ...
    public function unregisterComponent($component)
    {
        ...
        if ($component instanceof erpapi_shop_response_components_order_abstract) {
