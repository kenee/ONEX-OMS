...
class erpapi_store_response_stores extends erpapi_store_response_abstract
{
    ...
    public function listing($params){
        ...
        if ($params['store_bn']) {
            $filter['store_bn'] = $params['store_bn'];
        }

        if ($params['is_o2o']) {
            $filter['is_o2o'] = $params['is_o2o'];//0:不参加,1:参加
        }
