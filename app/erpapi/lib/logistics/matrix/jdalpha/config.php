...
class erpapi_logistics_matrix_jdalpha_config extends erpapi_logistics_matrix_config{
    ...
    public function get_query_params($method, $params){
        ...
        $shop = app::get('ome')->model('shop')->dump(array('shop_id'=> $jdalpha[1]), 'node_type,node_id');
        $query_params = array(
