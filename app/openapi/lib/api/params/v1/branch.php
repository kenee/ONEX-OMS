...
class openapi_api_params_v1_branch extends openapi_api_params_abstract implements openapi_api_params_interface{
    ...
    public function getAppParams($method){
        ...
        $params = array(
            'getList'=>array(
                ...
                'branch_bn' => array('type'=>'string', 'required'=>'false', 'name'=>'仓库编码', 'desc'=>'仓库编码,多个编码用逗号分隔'),
            ),
            // 'decrypt'=>array(
    ...
    public function description($method){
        $desccription = array(
                'getList'=>array('name'=>'查询仓库信息','description'=>'批量获取仓库信息数据'),
