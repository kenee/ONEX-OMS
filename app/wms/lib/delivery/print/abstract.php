...
class wms_delivery_print_abstract{
    ...
    protected function formatSaleStyleData($delivery)
    {
        ...
        if(isset($delivery['expire_bns'])){
            ...
            $wmsDlyItemsObj = app::get('wms')->model('delivery_items');
            $item_ids_arr = $wmsDlyItemsObj->getList('item_id,outer_item_id',array('delivery_id'=>$delivery['delivery_id']));
