 ...
 * @version 0.1
 */
class financebase_autotask_task_type_cainiaoAssignSku extends financebase_autotask_task_init
{
...
//        $remote_url = base64_decode($task_info['queue_data']['remote_url']);
        ...
        list($status,$errmsg) = $oTask->_spliteCainiaoData($local_file,$file_type,$task_info['queue_data']['shop_id'],$task_info, $remote_url,'cainiaoskuimport');
