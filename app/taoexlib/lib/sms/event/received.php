 ...
 */
/**
 * @description 物流签收短信触发事件
 * @access public
 * @param void
 * @return void
 */
class  taoexlib_sms_event_received extends taoexlib_sms_event_abstract implements taoexlib_sms_event_interface
{
     ...
     * @var string
     */
    protected $_tmplContent = '{收货人}，您好！您在{店铺名称}订购的商品,{物流公司}已签收，单号：{物流单号}，谢谢！{短信签名}';
    ...
    private function getLogiNoInfo($delivery_id, &$sendParams, &$error_msg){
        ...
        //获取线上发货短信模板
        $contentinfo = $rule_sample_mdl->getOtherSmsContent('received');
