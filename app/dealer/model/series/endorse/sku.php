 ...
 * @version 2024.04.12
 */
class dealer_mdl_series_endorse_sku extends dbeav_model
{
    //列表排序
    ...
    {
        $table_name = 'series_endorse_products';
        if($real){
            return 'sdb_dealer_series_endorse_products';
        }else{
            return $table_name;
        }
    }
    ...
    {
        $cols = 's.series_id,s.series_code,s.series_name,s.status,s.betc_id,p.sep_id,p.shop_id,p.bm_id,p.op_name,p.from_time,p.end_time,p.at_time,p.up_time';
