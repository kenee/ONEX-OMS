...
class dealer_view_input{
     ...
     * @return mixed 返回值
     */
    public function input_dealer_object($params) 
    {
        $return_url = $params['return_url']?$params['return_url']:'index.php?app=dealer&ctl=admin_series&act=object_rows';
        ...
        if(isset($params['multiple']) && $params['multiple']){
            ...
            return $render->fetch('admin/series/input.html','dealer');
        }else{
            if($params['value']){
            ...
            $url = 'index.php?app=desktop&act=alertpages&goto='.urlencode('index.php?app=dealer&ctl=admin_series&act=finder_common&app_id='.$app_id.'&'.$object.$getdata);
            ...
            return $render->fetch('admin/series/input_radio.html','dealer');
        }
    }
}
