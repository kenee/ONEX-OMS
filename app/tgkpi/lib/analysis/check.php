...
class tgkpi_analysis_check extends eccommon_analysis_abstract implements eccommon_analysis_interface{
    ...
    public $graph_options = array(
        ...
        'iframe_height' => 180,
        'show' => 'bar',
        'callback' => 'tgkpi_mdl_analysis_check',
    );
    ...
    public function finder(){
        return array(
            'model' => 'tgkpi_mdl_analysis_check',
            'params' => array(
                'actions'=>array(
                    array(
                        ...
                        'class'=>'export',
                        'icon'=>'add.gif',
                        'href'=>'index.php?app=tgkpi&ctl=admin_analysis&act=check&action=export',
