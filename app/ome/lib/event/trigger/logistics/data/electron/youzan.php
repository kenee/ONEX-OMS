...
class ome_event_trigger_logistics_data_electron_youzan extends ome_event_trigger_logistics_data_electron_common {

    public function getDirectSdf($arrDelivery, $arrBill) {
        ...
        $sdf = parent::getDirectSdf($arrDelivery, $arrBill);
