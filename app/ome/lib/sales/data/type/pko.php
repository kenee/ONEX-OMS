...
class ome_sales_data_type_pko{
    ...
    public function doTrans($obj){
        ...
        foreach($items as $k =>$item){
            $mark = $k;
            $pko['order_id'] = $item['order_id'];
            $pko['item_id'] = $item['item_id'];
            $pko['obj_id'] = $item['obj_id'];
        }
        ...
        $delivery_items_detail_info = $delivery_items_detailObj->dump(array('order_id'=>$pko['order_id'],'order_item_id'=>$pko['item_id'],'order_obj_id'=>$pko['obj_id'],'delivery_id'=>$delivery_id));
