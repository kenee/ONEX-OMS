...
class ome_branch_flow_purchasein extends ome_branch_flow_abstract implements ome_branch_flow_interface
{
    /**
    ...
    public function getContent($id)
    {
        ...
        return $render->fetch('admin/branch/flow/purchasein.html');
    }
