...
class ome_security_meituan4medicine extends ome_security_hash
{
    // 订单加密字段
    ...
    protected $_original_fields = array(
        'uname' => 'receiver_name_index',
        'ship_name' => 'receiver_name_index',
        'ship_area' => 'receiver_area_index',
        'ship_province' => 'receiver_state_index',
        'ship_city' => 'receiver_city_index',
        'ship_district' => 'receiver_district_index',
        'ship_town' => 'receiver_street_index',
        'ship_tel' => 'receiver_phone_index',
