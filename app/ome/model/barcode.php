...
class ome_mdl_barcode{
    ...
    function code_39($data){
        ...
        $code = $lib['*'];
        $row1 = '<td rowspan="2" valign="top">'.$this->code_39_line(0,1,70).'</td>';
        $cell='';
        for($j=1;$j<10;$j++){
    ...
    function code_39_line($i,$b,$h){
        ...
        return '<img src="app/ome/statics/'.$file.'" class="x-barcode" width="'.($i?2:1).'pt" height="'.$h.'px" />';
    }
}
?>
